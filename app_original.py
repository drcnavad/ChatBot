...
if df is not None:
    # Get unique symbols for reference
    ...
    if 'selected_ticker' in st.session_state and st.session_state.selected_ticker:
        ...
        # Update the text input key to force refresh
    ...
    with col1:
        ticker_input_value = st.session_state.get('ticker_input', '') or (selected_ticker if selected_ticker else '')
